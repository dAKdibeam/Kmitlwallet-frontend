    ...
    this.http
      ...
      .subscribe(
        response => {
          ...
          const token = response.payload.user.token;
          this.token = token;
          if (token) {
            const expiresInDuration = response.payload.user.expiresId;
            this.setAuthTimer(expiresInDuration);
            this.isAuthenticated = true;
            this.userId = response.payload.user.id;
            this.account = response.payload.user.account;
            this.balance = response.payload.user.balance;
